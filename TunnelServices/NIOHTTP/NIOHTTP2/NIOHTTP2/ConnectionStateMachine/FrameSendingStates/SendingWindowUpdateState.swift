...
protocol SendingWindowUpdateState: HasFlowControlWindows {
...
extension SendingWindowUpdateState {
    mutating func sendWindowUpdate(streamID: HTTP2StreamID, increment: UInt32) -> StateMachineResultWithEffect {
