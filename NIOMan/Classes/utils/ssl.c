...
/*
 * Returns the result of ssl_key_identifier_sha1() as hex characters with or without colons in a newly allocated string.
 * 在新分配的字符串中，返回ssl_key_identifier_sha1()的结果为带或不带冒号的十六进制字符。
 */
char *
